...
## Step 4: Fix node:sqlite (if Node < 23)

Edit `%USERPROFILE%\.summarize\daemon.cmd` to add the `--experimental-sqlite` flag:

```cmd
@echo off
set GEMINI_API_KEY=<YOUR_GEMINI_API_KEY>
set OPENAI_API_KEY=<YOUR_NVIDIA_API_KEY>
...
## Step 6: Create hidden-window launcher (optional)
